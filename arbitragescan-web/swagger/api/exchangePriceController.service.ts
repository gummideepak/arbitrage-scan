...
import { ArbitrageDto } from '../model/arbitrageDto';

import { BASE_PATH, COLLECTION_FORMATS }                     from '../variables';
import { Configuration }                                     from '../configuration';
import { ExchangePriceDto } from 'swagger';
...
export class ExchangePriceControllerService {
     ...
     */
    public getArbitrageListUsingGET(cryptoTickerList: Array<string>, fiatCurrency?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<ArbitrageDto>>;
    public getArbitrageListUsingGET(cryptoTickerList: Array<string>, fiatCurrency?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ArbitrageDto>>>;
    public getArbitrageListUsingGET(cryptoTickerList: Array<string>, fiatCurrency?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ArbitrageDto>>>;
    public getArbitrageListUsingGET(cryptoTickerList: Array<string>, fiatCurrency?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (cryptoTickerList === null || cryptoTickerList === undefined) {
            throw new Error('Required parameter cryptoTickerList was null or undefined when calling getArbitrageListUsingGET.');
        }
        ...
        return this.httpClient.get<Array<ArbitrageDto>>(`${this.basePath}/getArbitrageList`,
            {
